...
Kartan Sitescreening är skapad som ett verktyg åt Invest in Dalarna[^1]. Syftet med kartan är att hitta nya siter för etablering av elintensiva företag. Förebilden för analysen finns i Västernorrlands High Coast Invest vilka tillsammans med SWECO hittade åtminstone en större site[^2]. Kartan är en del av ett pågående arbete att skapa en Region-Atlas, ett interaktivt kartverktyg som ska innehålla all geografisk information som angår Region Dalarna. Förebilden är Region Östergötlands Region-Atlas[^3].

Analysen i kartan bygger på flera kriterier varav de två viktigaste parametrarna saknas: (1) digitala översiktsplaner och (2) data från regionnätsägare om utmatning av el; dels var utmatning kan ske men också storleken på uttaget (megawatt). Varje kriterie har poängsatts godtyckligt beroende på avstånd och dess värde för en ny etablering av elintensiv industri. Visualiseringen av poängsättningen går från rött till gult där de bästa siterna är i rött. I kartan är det möjligt att tända och släcka lager och att zooma in och ut. Det senaste lagret som tänds ligger överst. Tryck [här](https://region-dalarna.github.io/Sitescreening/) för att se kartan i helskärm. 
...
Stoplager:
Jordbruksmark, bostäder och naturskyddsområden. Ej hänsyn till strandskydd.
